...
![Компиляция шаблона](image52.png){#fig:002 width=70%}

После я удаляю сгенерированные файлы с помощью команды make clean (рис. -@fig:003)

![Удаление сгенерированных шаблонов](image52.png){#fig:003 width=70%}

С помощью редактора выполняю отчет по выполненной лабораторной работе улюлю (рис. -@fig:004)
