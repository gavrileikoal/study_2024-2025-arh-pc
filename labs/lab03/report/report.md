...
![Обновление изменений в директории курса](image/1.jpg){#fig:001 width=70%}
...
![Удаление сгенерированных шаблонов](image/3.jpg){#fig:003 width=70%}

С помощью редактора выполняю отчет по выполненной лабораторной работе (рис. -@fig:004)

![Подготовка отчёта](image/4.jpg){#fig:004 width=70%}
...
![Выполнение отчета по 2 лабораторной работе](image/5.jpg){#fig:005 width=70%}
